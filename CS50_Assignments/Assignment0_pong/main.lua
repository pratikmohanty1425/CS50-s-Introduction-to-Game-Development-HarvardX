...
function love.draw()
    ...
    if gameState == 'choose' then
        ...
        love.graphics.printf('Choose Your Mode!', 0, 80, VIRTUAL_WIDTH, 'center')

        love.graphics.setFont(smallFont)
        love.graphics.printf('1. Player 1 VS Player 2!', 0, 100, VIRTUAL_WIDTH, 'center')
        love.graphics.printf('2. Player 1 VS Computer!', 0, 110, VIRTUAL_WIDTH, 'center')
        love.graphics.printf('3. Computer VS Computer!', 0, 120, VIRTUAL_WIDTH, 'center')
        f=1
    ...
    elseif gameState == 'start' then
        ...
        if choise == 1 then
            love.graphics.printf('Player 1 VS Player 2!', 0, 10, VIRTUAL_WIDTH, 'center')
        elseif choise == 2 then
            love.graphics.printf('Player 1 VS Computer!', 0, 10, VIRTUAL_WIDTH, 'center')
        elseif choise == 3 then
        love.graphics.printf('Computer VS Computer!', 0, 10, VIRTUAL_WIDTH, 'center')
        end
