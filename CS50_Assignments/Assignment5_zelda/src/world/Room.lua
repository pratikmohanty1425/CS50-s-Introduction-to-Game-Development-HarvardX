...
function Room:generateObjects()
    ...
    -- update 2 generate pots
    local numPots = math.random(2,6)
    while numPots > 0 do 
        local pot = Pot(
        ...
        if entity.health <= 0 then
            ...
            if not entity.dead and math.random(3)==1 then
                local heart = GameObject(
                    ...
                    --location to spawn
                    entity.x + entity.width / 2 - GAME_OBJECT_DEFS['heart'].width / 2,
                    entity.y + entity.height / 2 - GAME_OBJECT_DEFS['heart'].height / 2
                )
...
function Room:render()
    ...
    -- update 2
    -- render the lifted and flying pot 
